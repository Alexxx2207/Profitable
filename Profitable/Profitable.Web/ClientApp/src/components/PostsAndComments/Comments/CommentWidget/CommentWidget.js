                    ...
                    </header>
                    {
                        ...
                        <>
                            ...
                            <div className={styles.buttonSendContainer}>
                                <button className={styles.buttonSend} onClick={handleOnClickEditSend}>
                    ...
                    <footer className={styles.commentFooter}>
                        ...
                        { state.accountEmail === comment.authorEmail ?
                            <section className={styles.authorSection}>
                                <button className={styles.editCommentButton} onClick={handleOnClickEdit}>
                                    {
                                        state.editState ?
                                            <>
                                ...
                                <button className={styles.removeCommentButton} onClick={handleOnClickDelete}>
