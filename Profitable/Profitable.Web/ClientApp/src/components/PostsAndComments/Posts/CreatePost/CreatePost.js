...
export const CreatePost = () => {
    ...
    const onSubmit = (e) => {
        ...
        const clientErrors = Object.values(createState.errors).filter(
                ...
                .catch((err) => {
                    if (JWT && err.message === "Should auth first") {
                        setMessageBoxSettings(
                            JWT_EXPIRED_WHILE_EDITING_ERROR_MESSAGE + " The post was not created!",
                            false
                        );
                        removeAuth();
                        navigate("/login");
                    ...
                    <form className={styles.createForm} onSubmit={onSubmit}>
                        ...
                        <div className={styles.formGroup}>
                            ...
                            <textarea
                                ...
                                defaultValue={createState.values.content}
                                onChange={changeHandler}
                            />
                        </div>
                        <div className={styles.formGroup}>
