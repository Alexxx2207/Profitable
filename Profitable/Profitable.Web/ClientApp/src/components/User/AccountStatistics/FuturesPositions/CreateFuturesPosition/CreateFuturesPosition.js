            ...
            createPosition(
                ...
                .catch(err => {
                    if (JWT && err.message === 'Should auth first') {
                        setMessageBoxSettings(JWT_EXPIRED_WHILE_EDITING_ERROR_MESSAGE + ' The position was not created!', false);
                        removeAuth();
                        navigate('/login');
                    } else {
                        setState(state => ({
                ...
                <div className={styles.createContainer}>
                    <form className={styles.createForm} onSubmit={onSubmit} >
                        ...
                        <div className={styles.formGroup}>
                            ...
                            <select className={styles.selectContract} onChange={(e) => OnChangeContractType(e.target.value)} select={state.values.chosenContract.name}>
