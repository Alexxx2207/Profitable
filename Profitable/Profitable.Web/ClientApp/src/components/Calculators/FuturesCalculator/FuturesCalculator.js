...
import { loadFuturesContracts, CalculateTicks, CalculatePL } from '../../../services/futures/futuresService';
                ...
                <div className={styles.futuresInformation}>
                    <div className={styles.positionInformationContainer}>
                        ...
                        <div className={styles.exitPriceChange}>
                            <input className={styles.numberInput} type="number" onChange={(e) => exitPriceOnChange(e)} value={futures.position.exitPrice} />
                        </div>
                        ...
                        <div className={styles.contractsNumberChange}>
                            <input min={0} className={styles.numberInput} type="number" onChange={(e) => contractsNumberOnChange(e)} value={futures.position.numberOfContracts} />
                        </div>
                    </div>
            ...
            <div className={styles.answerWrapper}>
                ...
                <div className={styles.answerContainer}>
                    ...
                    <div className={styles.ticksValue}>
                        {
                            futures.answer.USDValue < 0 ?
                                    <h5 className={styles.redPL}>{Math.abs(futures.answer.ticks).toFixed(2)}</h5>    
                                :
                                    futures.answer.USDValue > 0 ?
                                        <h5 className={styles.greenPL}>{Math.abs(futures.answer.ticks).toFixed(2)}</h5>    
                                    :
                    ...
                    <div className={styles.dollarsValue}>
                        {
                            futures.answer.USDValue < 0 ?
                                <h5 className={styles.redPL}>-${Math.abs(futures.answer.USDValue).toFixed(2)}</h5>    
                            :
                                futures.answer.USDValue > 0 ?
                                    <h5 className={styles.greenPL}>${futures.answer.USDValue.toFixed(2)}</h5>    
                                :
