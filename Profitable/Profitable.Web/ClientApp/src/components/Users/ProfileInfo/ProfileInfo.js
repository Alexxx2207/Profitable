            ...
            <div className={styles.imageSection}>
                {profileInfo.previewImage ? (
                    <div className={styles.imageSectionButtons}>
                        <button className={styles.discardImageButton} onClick={discardClickHandler}>
                            Discard
                        </button>
                        <button className={styles.saveImageButton} onClick={saveClickHandler}>
                            Save
                        </button>
                    </div>
                ) : (
            ...
            <div className={styles.profileInfo}>
                {searchedProfileEmail === loggedInUserEmail ? (
                    <div className={styles.changeImageMessageContainer}>
                        <h6 className={styles.changeImageMessage}>
                            * Click on the circle to change your profile picture
                        </h6>
                    </div>
                ) : (
                    ""
                    ...
                    <div className={styles.editContainer}>
                        ...
                        <div className={styles.editForm}>
                            <EditUser
                                ...
                                searchedProfileEmail={searchedProfileEmail}
                            />
                        </div>
                    </div>
                    <div className={styles.editContainer}>
