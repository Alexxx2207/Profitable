            ...
            if (e.target.value === "") {
                setEditState((state) => ({
                    ...
                    errors: {
                        ...state.errors,
                        descriptionWhitespaces: {
                            text: "Description with no whitespaces\\n(can be left empty)",
                            fulfilled: true,
                            type: CLIENT_ERROR_TYPE,
                        },
                    },
                ...
                setEditState((state) => ({
                    ...
                    errors: {
                        ...state.errors,
                        descriptionWhitespaces: createClientErrorObject(
                            state.errors.descriptionWhitespaces,
                            isWhiteSpaceFieldChecker.bind(null, e.target.value)
                        ),
                    },
                }));
            }
                ...
                <form className={styles.editForm} onSubmit={onSubmit}>
                    ...
                    <div className={styles.formGroup}>
                        ...
                        <input
                            ...
                            name="firstName"
                            placeholder={"Steven"}
                            value={editState.values.firstName}
                    ...
                    <div className={styles.formGroup}>
                        ...
                        <input
                            ...
                            name="lastName"
                            placeholder={"Smith"}
                            value={editState.values.lastName}
                            onChange={changeHandler}
                        />
                    </div>
                    <div className={styles.formGroup}>
                        ...
                        <textarea
                            ...
                            name="description"
                            placeholder={
                                "I am a professional trader who constantly search reliable sources of information..."
                            }
